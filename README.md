...
![in-loss-bt](figs/in-loss-bt.png "Barlow Twins Loss") ![in-loss-reg](figs/in-loss-reg.png "MixUp Regularization Loss") ![in-linear](figs/in-linear.png "Linear Evaluation Results")
