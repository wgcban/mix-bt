...
### with cosine shedule###
## mbt-d1024-s2(0.0078125) ##
# 1000 epochs
# model_path=results/pbknx38b/pbknx38b_0.0078125_1024_256_stl10_model_1000.pth
...
# # 2000 epochs
# model_path=results/pbknx38b/pbknx38b_0.0078125_1024_256_stl10_model_2000.pth
# screen -S "$session_name" -X stuff "CUDA_VISIBLE_DEVICES=${gpu} python linear.py --dataset ${dataset} --model_path ${model_path} --arch ${arch} --epochs ${epochs}^M"
# # Best epoch
# model_path=results/pbknx38b/pbknx38b_0.0078125_1024_256_stl10_model.pth
# screen -S "$session_name" -X stuff "CUDA_VISIBLE_DEVICES=${gpu} python linear.py --dataset ${dataset} --model_path ${model_path} --arch ${arch} --epochs ${epochs}^M"


## bt-d1024-s(0.0078125) ## 
# 1000 epochs
model_path=results/neuv1l72/neuv1l72_0.0078125_1024_256_stl10_model_1000.pth
screen -S "$session_name" -X stuff "CUDA_VISIBLE_DEVICES=${gpu} python linear.py --dataset ${dataset} --model_path ${model_path} --arch ${arch} --epochs ${epochs}^M"
# 2000 epochs
model_path=results/neuv1l72/neuv1l72_0.0078125_1024_256_stl10_model_1600.pth
screen -S "$session_name" -X stuff "CUDA_VISIBLE_DEVICES=${gpu} python linear.py --dataset ${dataset} --model_path ${model_path} --arch ${arch} --epochs ${epochs}^M"
# Best epoch
model_path=results/neuv1l72/neuv1l72_0.0078125_1024_256_stl10_model.pth
screen -S "$session_name" -X stuff "CUDA_VISIBLE_DEVICES=${gpu} python linear.py --dataset ${dataset} --model_path ${model_path} --arch ${arch} --epochs ${epochs}^M"
